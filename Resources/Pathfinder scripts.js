(function(){ // # Comments by Joe.
    ...
    var global = {
        ...
        objectIsTooClose: function(objectGroup, distance) {
            var args = {
                ...
                if (global.list.length != 0) {
                    ...
                    if (list.length > 1) {
                        ...
                        if (jumpTile.direction == global.movement.Jump && (global.isWallTouching(8, instanceId) || global.isObjectTouching(8, instanceId, 0, -1, -3))) {
                            ...
                            if (global.objectIsTooClose(4, 400) && (global.isWallTouching(8, instanceId) || global.isObjectTouching(8, instanceId))) {
                                return true;
                            }
                        }
                    }       
